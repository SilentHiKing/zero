 ...
 * </ul>
 * <p>在 xml 中采用 {@link com.hiking.base.R.styleable#FloatLayout} 控制以上属性。</p>
 */
public class FloatLayout extends ViewGroup {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        int maxLines = array.getInt(R.styleable.FloatLayout_android_maxLines, -1);
        if (maxLines >= 0) {
            setMaxLines(maxLines);
        }
        int maxNumber = array.getInt(R.styleable.FloatLayout_maxNumber, -1);
        if (maxNumber >= 0) {
